...
export class ArticulosService {
    ...
    setCarShoping() {
      ...
      agregarItemShoping(cant) {
        ...
        let encontrado = -1;
        for (let j = 0; j < this.carShoping.length; j++) {
        ...
        debugger;
        this.setCantidad(this.carShoping.length);
      }

      setCantidad(cantiad) {
        sessionStorage.setItem('ShopCounter', String(cantiad));
      }
    ...
    getCantidad() {
      return sessionStorage.getItem('ShopCounter');
    }
}
